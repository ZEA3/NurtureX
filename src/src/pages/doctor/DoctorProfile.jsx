...
//
// Doctor edits their own profile: name, phone, specialty, bio, avatar.
// Email and role are read-only (controlled by admin/auth).

import { useState } from 'react'
import { Save, Mail, ShieldCheck, AlertCircle, MapPin, Building2 } from 'lucide-react'
  ...
  return (
    <>
      <div className="mb-7">
        ...
        <p className="text-sm text-slate-500 dark:text-zinc-500 mt-1">Update your profile info and avatar.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="rounded-2xl bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 p-6">
          ...
          <div className="mt-5 text-center">
            ...
            <p className="text-sm text-slate-500 dark:text-zinc-400 mt-0.5">{form.specialty || '—'}</p>
        ...
        <div className="lg:col-span-2 rounded-2xl bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 p-6">
          ...
          <form onSubmit={onSave} className="space-y-1">
            ...
            <Field label="Specialty">
              <Input value={form.specialty} onChange={update('specialty')} placeholder="e.g. Pediatrics" disabled={saving} />
            </Field>
